...
<head>
    ...
    <!-- Modern Layout CSS (Header, Navbar, Tables, Settings) -->
    <link href="{{ asset('css/modern-layout.css') }}?v={{ file_exists(public_path('css/modern-layout.css')) ? filemtime(public_path('css/modern-layout.css')) : '1.0' }}" rel="stylesheet" />
    <link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css"
        integrity="sha256-p4NxAoJBhIIN+hmNHrzRCf9tD/miZyoHS5obTRR9BMY=" crossorigin="" />
    <link href="https://cdn.datatables.net/v/bs5/dt-2.3.7/r-2.5.0/datatables.min.css" rel="stylesheet" />
    @stack('css')
</head>
...
<body>
    ...
    <script src="https://cdn.datatables.net/v/bs5/dt-2.3.7/r-2.5.0/datatables.min.js"></script>
