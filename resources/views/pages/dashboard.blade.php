                ...
                <div class="card-header">
                    <div>
                        <h3 class="card-title">
                            ...
                            Data Halaman Yang Dapat Di Akses Untuk {{ Auth::user()->name }}
                        </h3>
                        <p class="text-muted mb-0 mt-1">Isi Data Pelanggan Di Bawah Ini</p>
                    </div>
                                                        ...
                                                        <div class="text-muted small">
                                                            ...
                                                            @if($upg->vlan->count() > 0)
                                                                <div class="text-truncate">
                                                                    VLAN: {{ $upg->vlan->pluck('vlan.name')->filter()->join(', ') }}
                                                                </div>
                                                            @endif
                                                        </div>
                                                    </div>
