        ...
        <div class="org-card">
            ...
            <div class="org-header">
                <div class="org-title-wrap">
                    <div class="org-header-icon" style="background:linear-gradient(135deg,#ffedd5,#fed7aa);color:#ea580c;">
                    ...
                    <div>
                        <h2 class="org-title">Data ODP</h2>
                        <p class="org-subtitle mb-0">Kelola master data Optical Distribution Point (ODP).</p>
                    </div>
                </div>
            ...
            <div class="org-toolbar">
                ...
                <div class="search-wrapper">
                    ...
                    <input type="text" class="org-input w-100" id="search-input" placeholder="Cari ODP...">
                </div>
            </div>

            {{-- Table --}}
            <div class="table-responsive">
                <table class="org-table" id="odp-table">
                    <thead>
                        <tr>
            ...
            <div class="modal-content" style="border-radius:18px;overflow:hidden;border:none;">
                ...
                <div class="modal-header"
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h5 class="modal-title mb-0" style="color:white;font-weight:700;font-size:.95rem;">Tambah ODP</h5>
                    </div>
                ...
                <div class="modal-body" style="padding:1.5rem;">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="code">Kode ODP</label>
...
@push('js')
    <script>
        ...
        function deleteODP(id) {
            Swal.fire({
                title: "Hapus ODP?",
                text: "Data ODP ini akan dihapus permanen.",
                icon: "warning",
