    ...
    <div class="org-card">
        <div class="org-header">
            <div class="org-title-wrap">
                ...
                <div>
                    <h3 class="org-title">Data Kabupaten</h3>
                    <p class="org-subtitle mb-0">Kelola master data kabupaten/kota</p>
                </div>
            </div>
            @can('buat kabupaten')
        ...
        <div class="org-toolbar">
            <div class="d-flex align-items-center gap-2">
                ...
                <select name="sort" id="sort" class="form-select org-input"
                    style="width: 80px; padding: 0.35rem 1.8rem 0.35rem 0.8rem;">
                    @php
                        $opts = [10, 25, 50, 100];
                    @endphp
                    @foreach ($opts as $opt)
            ...
            <div class="search-wrapper">
                ...
                <input type="text" class="org-input" id="search-input" placeholder="Cari kabupaten..."
                    autocomplete="off">
            </div>
        </div>

        <div id="kabupaten-table-wrapper" class="table-responsive">
            <table class="table org-table table-vcenter text-nowrap" id="kabupaten-table">
                <thead>
                    <tr>
                        <th class="w-1">No</th>
                        <th>Kode</th>
        ...
        <div class="org-footer border-top py-3 px-4 d-flex align-items-center justify-content-between">
            ...
            <ul class="pagination m-0" id="custom-pagination">
            </ul>
        </div>
    </div>
@endsection
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-4">
                        <label for="name" class="form-label mb-2 fw-medium text-muted">Nama Kabupaten</label>
                        <input type="text" name="name" id="name" class="org-input w-100 placeholder-muted"
...
@endif
        ...
        function clearValidationErrors() {
            $(".org-input, .form-control").removeClass('is-invalid');
