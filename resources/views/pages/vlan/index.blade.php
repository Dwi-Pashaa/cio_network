        ...
        <div class="org-card">
            ...
            <div class="org-header">
                <div class="org-title-wrap">
                    ...
                    <div>
                        ...
                        <p class="org-subtitle mb-0">Kelola seluruh data VLAN di jaringan.</p>
                    </div>
                </div>
            ...
            <div class="org-toolbar">
                ...
                <div class="search-wrapper">
                    ...
                    <input type="text" class="org-input w-100" id="search-input" placeholder="Cari VLAN...">
                </div>
            </div>
            ...
            <div class="modal-content" style="border-radius:18px;overflow:hidden;border:none;">
                ...
                <div class="modal-header"
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h5 class="modal-title mb-0" style="color:white;font-weight:700;font-size:.95rem;">Tambah VLAN
                        </h5>
                    </div>
                ...
                <div class="modal-body" style="padding:1.5rem;">
                    ...
                    <div class="mb-0">
                        <label class="form-label" for="name">Nama VLAN</label>
                        <input type="text" name="name" id="name" class="form-control"
                            placeholder="Contoh: VLAN 10 - Management">
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            ...
                            // Ambil inisial huruf, abaikan karakter non-alfabet jika bukan awalan
                            const initial = data.replace(/[^a-zA-Z0-9]/g, '').charAt(0).toUpperCase() ||
                            'V';
                            return `
                            <div class="d-flex align-items-center gap-2">
                                <div style="width:32px;height:32px;border-radius:9px;background:linear-gradient(135deg,#e0e7ff,#c7d2fe);
                                    color:#4f46e5;font-size:.78rem;font-weight:800;display:flex;align-items:center;
