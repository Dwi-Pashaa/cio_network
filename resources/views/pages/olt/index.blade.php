                ...
                <div class="modal-body" style="padding:1.5rem;">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="file" name="document" id="document" class="form-control" accept=".pdf,.doc,.docx,.xls,.xlsx,.png,.jpg,.jpeg">
            ...
            $("#document").on('change', function() {
                ...
                if (file) {
                    ...
                    if (file.type === "application/pdf") {
                        ...
                        const fileURL = URL.createObjectURL(file);
                        container.find('.detail-link').attr('href', fileURL).attr('target', '_blank').text('Lihat Gambar').show().off('click');
                    } else {
