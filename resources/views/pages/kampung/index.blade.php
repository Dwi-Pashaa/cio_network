    ...
    <div class="org-card">
        <div class="org-header">
            <div class="org-title-wrap">
                ...
                <div>
                    <h3 class="org-title">Data Kampung</h3>
                    <p class="org-subtitle mb-0">Kelola master data kampung/pemukiman</p>
                </div>
            </div>
            @can('buat kampung')
        ...
        <div class="org-toolbar">
            ...
            <div class="search-wrapper">
                ...
                <input type="text" class="org-input" id="search-input" placeholder="Cari kampung..." autocomplete="off">
            </div>
        </div>

        <div id="kampung-table-wrapper" class="table-responsive">
            <table class="table org-table table-vcenter text-nowrap" id="kampung-table">
                <thead>
                    <tr>
                        <th class="w-1">No</th>
                        <th>Kode</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label for="name" class="form-label fw-medium text-muted">Nama Kampung</label>
