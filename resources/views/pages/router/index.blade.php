...
<div class="card">
    ...
    <div class="card-footer d-flex align-items-center">
        <p class="m-0 text-secondary">
            Showing <span>{{ $routers->firstItem() }}</span> 
            to <span>{{ $routers->lastItem() }}</span> of
            <span>{{ $routers->total() }}</span> entries
        </p>
    ...
    <div class="modal-dialog modal-1 modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Router</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    <label for="name" class="mb-2">Nama Router</label>
...
<script>
    const advancedTable = {
        headers: [
            { "data-sort": "sort-name", name: "Nama Router" },
...
<script>
    ...
    $("#addBtn").click(function() {
        $(".modal-title").html("Tambah Router");
        $("#name").val("");
        $("#type").val("create");
        $("#id").val("");
    });
