    ...
    <div class="org-card">
            ...
            <div class="org-title-wrap">
                <div class="org-header-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <path d="M14 21v-4a2 2 0 0 0 -4 0v4" />
                    </svg>
                </div>
                <div>
                    <h3 class="org-title">Data Desa</h3>
                    <p class="org-subtitle mb-0">Kelola master data desa/kelurahan</p>
                </div>
            </div>
            @can('buat desa')
        ...
        <div class="org-toolbar">
            ...
            <div class="search-wrapper">
                ...
                <input type="text" class="org-input" id="search-input" placeholder="Cari desa..." autocomplete="off">
            </div>
        </div>

        <div id="desa-table-wrapper" class="table-responsive">
            <table class="table org-table table-vcenter text-nowrap" id="desa-table">
                <thead>
                    <tr>
                        <th class="w-1">No</th>
                        <th>Kode</th>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="regencie_id" class="form-label fw-medium text-muted">Kabupaten/Kota</label>
                        ...
                        <div class="col-md-6">
                            <label for="district_id" class="form-label fw-medium text-muted">Kecamatan</label>
                            <select name="district_id" id="district_id" class="org-input w-100">
                                <option value="">-- Pilih Kecamatan --</option>
                                @foreach ($district as $dd)
                                    <option value="{{ $dd->id }}">{{ $dd->name }}</option>
                                @endforeach
                            </select>
                            <span class="invalid-feedback error_district_id mt-1" style="font-size:0.85rem;"></span>
                        </div>
                        <div class="col-12">
                            <label for="name" class="form-label fw-medium text-muted">Nama Desa</label>
            ...
            table = $('#desa-table').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        searchable: false,
                        visible: {{ auth()->user()->can('ubah desa') || auth()->user()->can('hapus desa') ? 'true' : 'false' }}
                    }
                ],
